...
always@(*) begin
	...
	case (r_cs)
		...
		ST_R_READ : r_ns = (o_rvalid & i_rready & last_rd) ? ST_R_END : ST_R_WAIT;
...
// ram_axi u_ram_axi (
    ...
    // .rd_addr(rd_addr[AXI_ADDR_WIDTH-1:AXI_BYTE_NUM]),    //256 bit a width
    // .rd_dout(o_rdata),

    // .wr_en  (wr_en  ),
    // .wr_addr(wr_addr[AXI_ADDR_WIDTH-1:AXI_BYTE_NUM]),    //256 bit  width
    // .wr_strb(i_wstrb),
    // .wr_data(i_wdata) 
